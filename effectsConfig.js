  ...
  avatar: {
    ...
    categories: {
      hades: {
        ...
        { name: "BG.zip", icon: "effect2.png" },
        { name: "FG.zip", icon: "efect3.png" },
        { name: "Full_Body.zip", icon: "effect4.png" },
        { name: "Eye_lenses.zip", icon: "effect5.png" },
        { name: "Hair.zip", icon: "effect1.png" },
        { name: "Lips.zip", icon: "effect2.png" },
